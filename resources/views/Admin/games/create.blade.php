...
<div class="max-w-3xl mx-auto">
    <div class="mb-6">
        <h2 class="text-3xl font-bold text-gray-800">Tambah Game Baru</h2>
        <p class="text-gray-600 mt-1">Isi form di bawah untuk menambahkan game baru</p>
    </div>
        ...
        <form action="/admin/games" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-6">
                ...
                <p class="text-xs text-gray-500 mt-2">
                    Rekomendasi: Ukuran 800x600px untuk hasil terbaik
                </p>
            </div>
